...
from rpi_deep_pantilt import __path__ as 
...
LABELS = ["Chemical_Sign","Aruco","Dangerous_Goods"]



class Signs_tiny_yolo_PostProcessed(object):

    PATH_TO_LABELS = rpi_deep_pantilt_path[0] + '/data/Signs_map.pbtxt'

    def __init__(
        self,
#         base_url='https://github.com/leigh-johnson/rpi-deep-pantilt/releases/download/v1.0.0/',
        model_name='Signs_tiny_yolo',
        input_shape=(320, 320),
